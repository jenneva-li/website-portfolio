...
//             document.title = "Portfolio | Jenneva Li";
...
var typed = new Typed(".typing-text", {
    strings: ["robotics", "artificial intelligence", "machine learning", "hardware development", "software development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showProjects(projects) {
    ...
    projects
        .slice(0, 10)
        .filter(project => project.category != "android")  // Exclude android category
        .forEach(project => {
            projectHTML += `
            <div class="box tilt">
                <img draggable="false" src="website-portfolio/assets/images/projects/${project.image}.png" alt="project" />
                <div class="content">
                    <div class="tag">
                        <h3>${project.name}</h3>
                    </div>
